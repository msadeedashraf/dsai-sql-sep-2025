...
select datediff(day, soh.ShipDate, soh.OrderDate) 
from SalesLT.SalesOrderHeader as soh

-- Step 6: Modify datetime with EOMONTH and DATEADD:
SELECT DATEADD(day,2,'20150113');

SELECT soh.OrderDate , DATEADD(day,2,soh.OrderDate) 
from SalesLT.SalesOrderHeader as soh;

SELECT EOMONTH('20251010'); --return the end of the month in which this date occurs
SELECT EOMONTH('20251010',2); --return the end of the month two months ahead of the this date

-- Step 7: Use ISDATE to check validity of inputs:
SELECT ISDATE('20151241'); --is valid
